...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, String> consumerFactory() { // 토픽에 접속하기위한 factory
        ...
        properties.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "k6e102.p.ssafy.io:9092");// 카푸카 서버 주소
        properties.put(ConsumerConfig.GROUP_ID_CONFIG, "consumerGroupId2");// 토픽  id
